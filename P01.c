...
void separacaoTimes(struct Iniciativa *time1, struct Iniciativa *time2, struct Iniciativa *iniciativa){

    //Codigo de separacao dos times

}



void IniciarCombate(struct Iniciativa *time1, struct Iniciativa *time2, struct Iniciativa *iniciativa){

        //codigo inicio do combate
